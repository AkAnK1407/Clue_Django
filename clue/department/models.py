...
class Fest(models.Model):
    ...
    department_name = models.ForeignKey('event.Department',null=True,on_delete=models.CASCADE)
    fest_poster = models.ImageField(upload_to='event_posters/', blank=True)
...
class dEvent(models.Model):
    ...
    event_start_date = models.DateTimeField()
    event_end_date = models.DateTimeField()
    department_name = models.ForeignKey('event.Department', on_delete=models.CASCADE)
